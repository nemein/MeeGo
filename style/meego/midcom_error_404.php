...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en"> 
  <head>
    ...
    <title>404 (Page Not Found) | MeeGo</title>
  </head>
  <body>
    <!-- page -->
    <div id="page-wrapper">
            ...
            <div id="drupal_content" class="column full">
              <div class="section"> 
                ...
                <div class="messages error">
                  <strong>Sorry, it looks like the page you are looking for cannot be found.</strong> 
                  Use the links below to find the page you are looking for, or report the error to the <a href="mailto:webmaster@meego.com" class="mailto">webmaster</a><span class="mailto"></span>.
                </div>
                <dl>
                  <dt>Check your spelling!</dt>
                  <dd>It's possible you inadvertently misspelled the page you are looking for. If you're not sure, search the site.</dd>
                  <dt>Search the site!</dt>
                  <dd>Use the search box at the top right of this page, or from the <a href="http://meego.com/search">search page</a>.</dd>
                  <dt>Browse the site!</dt>
                  <dd>Look around, you might end up finding what you were looking for!</dd>
                  <dt>Submit a bug!</dt>
                  <dd>Help make this site better! <a target="_blank" title="Submit a bug" href="http://bugs.meego.com/enter_bug.cgi?product=meego.com">Submit a bug</a> if you think this error needs to be fixed.<br>
                  </dd>
                </dl>
              </div>
            </div>
